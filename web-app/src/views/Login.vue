  ...
  <div style="min-height:100vh; background:var(--bg); display:grid; place-items:center; padding:24px;">
    <div style="width:100%; max-width:400px;" class="fade-up">
      ...
      <div style="text-align:center; margin-bottom:36px;">
        ...
        <h1 style="font-family:'Syne',sans-serif; font-weight:700; font-size:26px; color:var(--text); letter-spacing:-0.02em; margin-bottom:6px;">Vélométrix</h1>
        <p style="font-size:14px; color:var(--muted);">Connectez-vous à votre compte</p>
      </div>
      ...
      <div class="card" style="padding:28px;">
        <form @submit.prevent="submit" style="display:flex; flex-direction:column; gap:18px;">
          ...
          <div>
            ...
            <input v-model="password" type="password" required class="inp" placeholder="••••••••" />
          </div>
          ...
          <button type="submit" class="btn-primary" :disabled="loading" style="width:100%; padding:11px 18px; font-size:15px;">
